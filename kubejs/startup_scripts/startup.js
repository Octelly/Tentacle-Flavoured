...
// Food & drinks
	...
	event.create('butterscotch_cinnamon_pie_slice').displayName('Slice of Butterscotch Cinnamon Pie').food(food => {
		food
    		.hunger(3)
    		.saturation(0.65)
	...
	event.create('prickly_pear_pie_slice').displayName('Slice of Prickly Pear Pie').group('food').food(food => {
		food
    		.hunger(3)
    		.saturation(0.3)
	...
	event.create('mixed_oatmeal').displayName('Mixed Oatmeal').group('food').maxStackSize(16).food(food => {
		food
    		.hunger(11)
    		.saturation(0.8)
			.effect('farmersdelight:comfort', 6000, 0, 100)
...
StartupEvents.registry('block', event => {
	...
	event.create('prickly_pear_pie', 'farmersdelight:pie').soundType('wool').sliceItem('kubejs:prickly_pear_pie_slice').displayName('Prickly Pear Pie').tagBlock('farmersdelight:mineable/knife')
})
...
// Block blast resistance
  ...
  event.modify('create_confectionery:chocolate_bricks', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:chocolate_bricks_stairs', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:chocolate_bricks_slab', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:black_chocolate_bricks', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:black_chocolate_bricks_stairs', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:black_chocolate_bricks_slab', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:white_chocolate_bricks', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:white_chocolate_bricks_stairs', block => {
    block.requiresTool = false
  })
  event.modify('create_confectionery:white_chocolate_bricks_slab', block => {
    block.requiresTool = false
  })
})
