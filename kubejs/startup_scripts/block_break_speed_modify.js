BlockEvents.modification(event => {
	...
	breakFast('domesticationinnovation:pet_bed_white', 0.2)
	breakFast('domesticationinnovation:pet_bed_orange', 0.2)
	breakFast('domesticationinnovation:pet_bed_magenta', 0.2)
	breakFast('domesticationinnovation:pet_bed_light_blue', 0.2)
	breakFast('domesticationinnovation:pet_bed_yellow', 0.2)
	breakFast('domesticationinnovation:pet_bed_lime', 0.2)
	breakFast('domesticationinnovation:pet_bed_pink', 0.2)
	breakFast('domesticationinnovation:pet_bed_gray', 0.2)
	breakFast('domesticationinnovation:pet_bed_light_gray', 0.2)
	breakFast('domesticationinnovation:pet_bed_cyan', 0.2)
	breakFast('domesticationinnovation:pet_bed_purple', 0.2)
	breakFast('domesticationinnovation:pet_bed_blue', 0.2)
	breakFast('domesticationinnovation:pet_bed_brown', 0.2)
	breakFast('domesticationinnovation:pet_bed_green', 0.2)
	breakFast('domesticationinnovation:pet_bed_red', 0.2)
	breakFast('domesticationinnovation:pet_bed_black', 0.2)
